...
namespace Model
{
    ...
    void DebugCube::bakeGeometry(const Renderer::ShaderPalette &shaderPalette, Renderer::GeometryBuilder &builder) const
    {
        ...
        if ( m_bDrawFrame )
        {
            ...
            builder.setShaderId(shaderPalette.shader(Renderer::ShaderPalette::UnlitPerVertexColor));
