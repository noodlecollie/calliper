...
namespace NS_MODEL
{
    class MODELSHARED_EXPORT TexturePlane : public QObject, public ISerialisable
    {
        Q_OBJECT
    public:
        ...
        static void uvAxes(NS_UTIL::Math::AxisIdentifier axis, QVector3D &uAxis, QVector3D &vAxis);
